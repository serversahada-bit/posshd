...
function NavItem({ href, icon: Icon, label, active, count }: NavItemProps) {
  return (
    <Link href={href} className={`sidebar__link ${active ? 'sidebar__link--active' : ''} flex items-center justify-between`}>
      ...
      >
        ...
        <nav className="sidebar__nav custom-scrollbar">
            ...
            <div className="sidebar__section">
                ...
                <div>
                    <button
                      className={`sidebar__toggle ${(pathname.startsWith('/setting_scalev') || pathname.startsWith('/scalev_ubah_status') || pathname.startsWith('/scalev_bundling') || pathname.startsWith('/pos_to_scalev') || openSubmenu === 'scalev') ? 'sidebar__toggle--active' : ''}`}
                    ...
                    >
                        ...
                        <ChevronDown className={`sidebar__chevron ${(pathname.startsWith('/setting_scalev') || pathname.startsWith('/scalev_ubah_status') || pathname.startsWith('/scalev_bundling') || pathname.startsWith('/pos_to_scalev') || openSubmenu === 'scalev') ? 'sidebar__chevron--open' : ''}`} size={16} />
                    </button>

                    <div className={`sidebar__submenu ${(pathname.startsWith('/setting_scalev') || pathname.startsWith('/scalev_ubah_status') || pathname.startsWith('/scalev_bundling') || pathname.startsWith('/pos_to_scalev') || openSubmenu === 'scalev') ? '' : 'sidebar__submenu--closed'}`}>
                        ...
                        <SubmenuItem href="/pos_to_scalev" label="POS to Scalev" active={pathname === '/pos_to_scalev'} />
                    </div>
                </div>
                )}
